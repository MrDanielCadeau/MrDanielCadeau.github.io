    ...
    <div class="home">
      <div class="leftPart">
        <div class="profileCard">
          <img :src="this.profile.img" alt="black/white picture of me" />
        ...
        <div class="skills">
          ...
          <div>
            <ul class="languages">
              ...
              <li v-for="language in this.profile.skills.languages" :key="language">
                {{language}}
              </li>
            </ul>
            ...
            <ul class="frameworks">
              ...
              <li v-for="framework in this.profile.skills.frameworks" :key="framework">
                {{framework}}
              </li>
            </ul>
          </div>
